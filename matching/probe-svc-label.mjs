...
try {
  ...
  await p.goto("https://beachfrontdentistry.com/services", {
  ...
  // detail page h1
  await p.goto("https://beachfrontdentistry.com/services/dental-veneers", {
    waitUntil: "networkidle",
    timeout: 60000,
  });
  const h = await p.evaluate(() =>
    [...document.querySelectorAll("h1,h2")].slice(0, 4).map((e) => ({
      tag: e.tagName,
      cls: e.className,
