...
const shots = [
  [
    "http://localhost:5173/team-members/dr-robert-quan",
    "matching/dt-team-cand.png",
    1200,
  ],
  [
    "http://localhost:5173/services/dental-exams",
    "matching/dt-svc-cand.png",
    1500,
  ],
  [
    "http://localhost:5173/questions/regular-dental-cleanings-support-your-whole-body-health",
    "matching/dt-qa-cand.png",
    1400,
  ],
];
