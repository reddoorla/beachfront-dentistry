...
**ask-the-doctor's 40-card grid** sits at 78–81% _even with `--mask-photos`_,
...
| services           | 1/15               | **4/15**   |
| ask-the-doctor     | _gate hard-failed_ | **7/15**   |
...
2. **Hard line breaks in the closing-CTA heading.** Live hard-codes
   ...
   breaks into all three places that define that heading. This is _content_, so
...
- **person.teaser** — live shows a short _authored_ teaser per person (77–101
