...
try {
  ...
  await p.screenshot({
    path: "/Users/tuckerlemos/Documents/GitHub/beachfront-dentistry/matching/yfv-cand.png",
    fullPage: true,
  });
  ...
  const markers = await p.evaluate(() => ({
    ...
    examSteps: document.querySelectorAll(".fv-exam-section .flex.items-start")
      .length,
  }));
